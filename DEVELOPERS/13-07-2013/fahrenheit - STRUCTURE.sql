...
--
-- Host: localhost
-- Generation Time: Jul 12, 2013 at 08:40 PM
...
ALTER TABLE `profile_picture`
  ADD CONSTRAINT `profile_picture_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`profilepic`) REFERENCES `profile_picture` (`id`);
